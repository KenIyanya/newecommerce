<template>
  ...
  <mdb-footer color="unique-color-dark" class="page-footer font-small pt-0">
    <div style="backgroundColor: #ff3547">
    ...
    <mdb-container class="mt-5 mb-4 text-center text-md-left">
      <mdb-row class="mt-3">
        <mdb-col md="3" lg="4" xl="3" class="mb-4">
          <h6 class="text-uppercase font-weight-bold"><strong>Gifted Store</strong></h6>
          <hr class="danger-color accent-2 mb-4 mt-0 d-inline-block mx-auto" style="width: 60px" />
          <p>Welcome</p>
        </mdb-col>
        <mdb-col md="2" lg="2" xl="2" class="mb-4">
          <h6 class="text-uppercase font-weight-bold"><strong>LET US HELP YOU</strong></h6>
          <hr class="danger-color accent-2 mb-4 mt-0 d-inline-block mx-auto" style="width: 60px" />
          <p><a href="#!">Help Center</a></p>
          <p><a href="#!">Contact us</a></p>
          <p><a href="#!">How to shop</a></p>
          <p><a href="#!">Delivery options</a></p>
        </mdb-col>
        <mdb-col md="3" lg="2" xl="2" class="mb-4">
          <h6 class="text-uppercase font-weight-bold"><strong>ABOUT GIFTED STORE</strong></h6>
          <hr class="danger-color accent-2 mb-4 mt-0 d-inline-block mx-auto" style="width: 60px" />
        ...
        <mdb-col md="4" lg="3" xl="3" class="mb-4">
          ...
          <hr class="danger-color accent-2 mb-4 mt-0 d-inline-block mx-auto" style="width: 60px" />
          <p><i class="fas fa-home mr-3"></i> ABUJA,  TIIDElab, NIGERIA</p>
          <p><i class="fas fa-envelope mr-3"></i> info@example.com</p>
          <p><i class="fas fa-phone mr-3"></i> + 234 234 567 88</p>
          <p><i class="fas fa-print mr-3"></i> + 234 234 567 89</p>
        </mdb-col>
      </mdb-row>
    </mdb-container>
    <div class="footer-copyright text-center py-3">
      <mdb-container fluid>
        &copy; 2020 Copyright: <a href="https://www.MDBootstrap.com"> Giftedstore.com </a>
      </mdb-container>
    </div>
  </mdb-footer>
  <!-- Footer -->
